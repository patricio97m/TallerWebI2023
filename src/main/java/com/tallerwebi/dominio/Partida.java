...
public class Partida {
    ...
    private boolean seRepartieronCartas;
    ...
    public Jugador calcularGanadorTirada(int tiradaActual) {
        if (cartasJugadasIa.getCarta(tiradaActual).getValorTruco() > cartasJugadasJugador.getCarta(tiradaActual)
                .getValorTruco()) {
            ronda.setResultadoTirada(tiradaActual, Jugador.IA);
            return Jugador.IA;
        } else if (cartasJugadasJugador.getCarta(tiradaActual).getValorTruco() > cartasJugadasIa.getCarta(tiradaActual)
                .getValorTruco()) {
    ...
    public boolean isSeRepartieronCartas() {
        return seRepartieronCartas;
    }

    public void setSeRepartieronCartas(boolean seRepartieronCartas) {
        this.seRepartieronCartas = seRepartieronCartas;
    }
}
